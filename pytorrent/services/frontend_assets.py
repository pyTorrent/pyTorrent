...
PYTORRENT_FRAMEWORK_EXTRA_THEMES = {
    "graphite-studio": "pyTorrent Graphite Studio",
    "openai": "pyTorrent OpenAI",
    "railway": "pyTorrent Railway",
    "candycode": "pyTorrent Candycode",
    "syntax": "pyTorrent Syntax",
    "midnight-terminal": "pyTorrent Midnight Terminal",
    "paper-ink": "pyTorrent Paper & Ink",
    "sunset-grid": "pyTorrent Sunset Grid",
    "luma-soft": "pyTorrent Luma Soft",
    "nova-compact": "pyTorrent Nova Compact",
    "maia-rounded": "pyTorrent Maia Rounded",
    "lyra-grid": "pyTorrent Lyra Grid",
    "mira-dense": "pyTorrent Mira Dense",
    "material-you": "pyTorrent Material You",
    "fluent-mica": "pyTorrent Fluent Mica",
    "carbon-console": "pyTorrent Carbon Console",
    "ant-enterprise": "pyTorrent Ant Enterprise",
    "chakra-sage": "pyTorrent Chakra Sage",
    "radix-mint": "pyTorrent Radix Mint",
    "base-ui": "pyTorrent Base UI",
    "daisy-caramel": "pyTorrent daisyUI Caramel",
    "daisy-abyss": "pyTorrent daisyUI Abyss",
    "primer-github": "pyTorrent Primer",
    "atlassian-blue": "pyTorrent Atlassian",
    "mantine-indigo": "pyTorrent Mantine Indigo",
    "glass-tahoe": "pyTorrent Tahoe Glass",
    "material-ocean": "pyTorrent Material Ocean",
    "neobrutal-pop": "pyTorrent Neo Brutal Pop",
    "bubblegum-blast": "pyTorrent Bubblegum Blast",
    "laser-arcade": "pyTorrent Laser Arcade",
    "pixel-party": "pyTorrent Pixel Party",
    "jelly-orbit": "pyTorrent Jelly Orbit",
    "comic-burst": "pyTorrent Comic Burst",
    "acid-matrix": "pyTorrent Acid Matrix",
    "synthwave-sunset": "pyTorrent Synthwave Sunset",
    "toxic-slime": "pyTorrent Toxic Slime",
    "cyber-sakura": "pyTorrent Cyber Sakura",
    "ice-pop": "pyTorrent Ice Pop",
    "lava-lamp": "pyTorrent Lava Lamp",
    "blueprint-lab": "pyTorrent Blueprint Lab",
    "retro-diner": "pyTorrent Retro Diner",
    "space-disco": "pyTorrent Space Disco",
    "gamer-rgb": "pyTorrent Gamer RGB",
    "pumpkin-panic": "pyTorrent Pumpkin Panic",
    "aqua-splash": "pyTorrent Aqua Splash",
    "royal-casino": "pyTorrent Royal Casino",
    "prism-punch": "pyTorrent Prism Punch",
    "marshmallow-cloud": "pyTorrent Marshmallow Cloud",
}
