...
CREATE TABLE IF NOT EXISTS user_preferences (
  ...
  pytorrent_theme_effects_enabled INTEGER DEFAULT 0,
  pytorrent_immersive_effects_enabled INTEGER DEFAULT 0,
  ...
  compact_torrent_list_enabled INTEGER DEFAULT 1,
  torrent_list_font_size INTEGER DEFAULT 12,
...
CREATE TABLE IF NOT EXISTS profile_preferences (
  ...
  tracker_favicons_enabled INTEGER DEFAULT 1,
