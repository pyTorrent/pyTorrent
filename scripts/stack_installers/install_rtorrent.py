...
def build_parser():
    parser = argparse.ArgumentParser(description="Installer for libtorrent + rTorrent under /opt. Version presets select compatible libtorrent and XML-RPC backends.")
